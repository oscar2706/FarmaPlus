...
public class PedidoAdapter extends RecyclerView.Adapter<PedidoAdapter.PedidoHolder> implements View.OnClickListener{
    ...
    public PedidoAdapter(List<Pedido> lista, int layout, Activity activity) {
        this.lista = lista;
        this.layout = layout;
    ...
    @Override
    public void onBindViewHolder(@NonNull PedidoAdapter.PedidoHolder holder, int position) {
